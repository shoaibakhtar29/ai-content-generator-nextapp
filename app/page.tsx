  ...
  <nav className="relative max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
    ...
    <div className=" ml-96">
      <ul className=" flex gap-5">
        <Link href={'/'}><li className=" font-bold text-xl cursor-pointer hover:bg-blue-500 hover:text-white rounded-md m-2 p-2">Home</li></Link>
        <Link href={'/dashboard/history'}><li className=" font-bold text-xl cursor-pointer hover:bg-blue-500 hover:text-white rounded-md m-2 p-2">History</li></Link>
        <Link href={'/dashboard'}><li className=" font-bold text-xl cursor-pointer hover:bg-blue-500 hover:text-white rounded-md m-2 p-2">Dashboard</li></Link>
        <Link href={'/dashboard/settings'}><li className=" font-bold text-xl cursor-pointer hover:bg-blue-500 hover:text-white rounded-md m-2 p-2">Setting</li></Link>
      </ul>
    </div>
  ...
  <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
    ...
    <div className="flex justify-center">
      ...
      href="tubeguruji.com" target="_blank">
        SHOAIBAKHTAR.ORG Membership - Join Now
